...
void nge::Texture::createImage(VkFormat format,  VkImageTiling tiling,  VkImageUsageFlags usage,  VkMemoryPropertyFlags properties){
...
void nge::Texture::transitionImageLayout(VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout){
    VkCommandBuffer commandBuffer = nge::beginSingleTimeCommands(commandPool, device);
...
void nge::Texture::createTextureImageView(VkFormat format){
