...
ne::SwapChainSupportDetails ne::query_swap_chain_support(VkPhysicalDevice device, VkSurfaceKHR surface){
...
ne::QueueFamilyIndices ne::find_queue_families(VkPhysicalDevice device, VkSurfaceKHR surface){
